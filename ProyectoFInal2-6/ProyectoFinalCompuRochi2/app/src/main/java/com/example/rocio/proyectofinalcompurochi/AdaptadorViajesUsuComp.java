...
/**
 * Created by Rocio on 16/11/2017.
 */

public class AdaptadorViajesUsuComp extends BaseAdapter {

    private ArrayList<Viaje> MiListaViajes;
    private Context MiContexto;
    View VistaADevolver;

    public AdaptadorViajesUsuComp (ArrayList<Viaje> ListaDeViajes, Context ContextoAUsar)
    {
    ...
    public View getView(final int PosicionActual, final View VistaActual, final ViewGroup GrupoActual)
    {
        ...
        VistaADevolver=InfladorDeLayouts.inflate(R.layout.listview_viajesusuariocomp, GrupoActual, false);
